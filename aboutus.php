...
?>
    ...
    <div class="wide">
        ...
        <h3 style="color: red">About the food culture in Spice Box</h3>
        <br>
        <h3 style="color: white">Order food & beverages online from Spice Box. <h3 style="color: white"></h3></h3>
    </div>
